...
abstract contract AuthorizedExecutor is ReentrancyGuard {
    ...
    function execute(address target, bytes calldata actionData) external nonReentrant returns (bytes memory) {
        ...
        // We call target.functionCall on calldata instead of using the selector we extracted and checked before
        // ref https://medium.com/@mattaereal/damnvulnerabledefi-abi-smuggling-challenge-walkthrough-plus-infographic-7098855d49a
